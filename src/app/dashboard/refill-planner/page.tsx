  ...
  return (
    <div className="flex flex-col bg-white h-[calc(100vh-88px)] overflow-hidden relative select-none font-sans antialiased text-[#0F172A]">
      <div className="flex-1 min-w-0 flex flex-col space-y-3 min-h-0 p-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center bg-white shrink-0">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-white border border-zinc-200 rounded-xl py-2.5 pl-10 pr-4 text-xs text-zinc-700 shadow-xs focus:outline-none focus:ring-1 focus:ring-zinc-400 focus:border-zinc-400 placeholder:text-zinc-400"
            />
          </div>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="w-full sm:w-48">
              ...
              >
                <SelectTrigger className="w-full h-10 rounded-xl border border-neutral-200 bg-white px-4 text-xs font-semibold text-neutral-800 hover:bg-neutral-50 transition cursor-pointer shadow-2xs">
              ...
              <table className="w-full text-left border-collapse bg-white">
                <thead>
                  <tr className="border-b border-zinc-200/80 text-[10px] uppercase font-extrabold tracking-wider text-[#6e6e6e] bg-white sticky top-0 z-10">
                    ...
                    <th className="py-4 px-6 bg-white text-center">Capacity</th>
                    ...
                    return (
                      <Fragment key={group.name}>
                        <tr className="bg-white">
                          ...
                          >
                            <div className="bg-[#e9ebed] rounded-xl pr-2 pl-4 py-2 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <span className="font-extrabold text-[#657875] text-sm">
                                  {group.name}
                                </span>
                                <span className="text-black font-semibold border border-green-700 text-[10px] px-2 py-1 rounded-full uppercase ml-2">
                                  {group.items.length}{" "}
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <button
                                  ...
                                  className="bg-[#101010] hover:bg-black disabled:bg-zinc-300 disabled:text-zinc-400 disabled:cursor-not-allowed text-white rounded-full px-5 py-2.5 text-[10px] font-extrabold uppercase tracking-wider transition-all cursor-pointer"
                                >
                                  CREATE PO
                                </button>
                              </div>
                        ...
                        {group.items.map((item) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="py-4 px-6 font-extrabold text-[#6e6e6e] bg-white text-center">
                              ...
                              <td className="py-4 px-6 bg-white text-center">
                                <input
                                  ...
                                  className="w-16 bg-white border border-[#dddddd] rounded-lg px-2 py-1.5 text-xs text-center text-[#101010] font-extrabold focus:outline-none focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400 mx-auto block"
                                />
                              </td>
