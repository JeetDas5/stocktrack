        ...
        >
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-2xs space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="relative flex items-center border border-zinc-200 rounded-xl bg-white px-3 py-2.5 focus-within:ring-2 focus-within:ring-[#16A34A]/20 focus-within:border-[#16A34A] transition-all">
                    <Calendar className="h-4 w-4 text-zinc-400 mr-2.5" />
                    <span className="text-xs font-extrabold text-zinc-800">
                      {formatDateToDisplay(workDate) || "Select Work Date"}
                    </span>
                    <Calendar className="h-4 w-4 text-zinc-400 ml-auto" />
                    <input
                      type="date"
                      value={workDate}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="relative flex items-center border border-zinc-200 rounded-xl bg-white px-3 py-2.5 focus-within:ring-2 focus-within:ring-[#16A34A]/20 focus-within:border-[#16A34A] transition-all">
                    ...
                    <Clock className="h-4 w-4 text-zinc-400 ml-auto" />
                    <input
                      type="time"
                      value={startTime}
          ...
          <div className="space-y-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-2xs space-y-4">
              <div className="flex items-center gap-2 text-[#16A34A] border-b border-zinc-100 pb-3">
                <Clock className="h-5 w-5" />
                <h3 className="text-sm font-extrabold text-[#0F172A]">
                  About Timesheet Entry
                </h3>
              </div>
              ...
              <ul className="space-y-3.5 text-xs text-zinc-600 font-semibold">
                <li className="flex items-start gap-3.5">
                  ...
                  <span>
                    Select the staff member and location where the work was
                    performed.
                  </span>
                </li>
                <li className="flex items-start gap-3.5">
                  <Clock className="h-4 w-4 text-zinc-400 shrink-0 mt-0.5" />
                  <span>Enter the start and end time for the work period.</span>
                </li>
                <li className="flex items-start gap-3.5">
                  <Coffee className="h-4 w-4 text-zinc-400 shrink-0 mt-0.5" />
                  <span>Add unpaid break time in minutes.</span>
                </li>
                <li className="flex items-start gap-3.5">
                  <Send className="h-4 w-4 text-zinc-400 shrink-0 mt-0.5" />
                  <span>Click Submit Timesheet to save the entry.</span>
                </li>
              </ul>
            </div>
          </div>
