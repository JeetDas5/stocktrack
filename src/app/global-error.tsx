...
export default function GlobalError({
  ...
  return (
    <html lang="en" className={`${inter.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-[#F1F5F9] text-zinc-900 font-sans">
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative w-full max-w-lg mx-4 z-10 animate-scale-in">
            <div className="bg-white border border-zinc-200 rounded-2xl p-10 shadow-xl shadow-zinc-200/50 text-center">
              ...
              <button
                onClick={reset}
                className="w-full bg-primary-green hover:bg-green-700 active:bg-green-800 text-white rounded-xl py-3 px-6 text-sm font-semibold tracking-wide shadow-md shadow-zinc-200 transition-all duration-200 flex items-center justify-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
