...
export default function InvitePage({
  ...
  useEffect(() => {
    const handleReset = () => setGoogleLoading(false);
            ...
            !otpSent ? (
              <div className="space-y-4 animate-scale-in text-center">
                ...
                <button
                  ...
                  disabled={googleLoading || sendingOtp || verifyingOtp}
                  className="w-full bg-white hover:bg-neutral-50 border border-neutral-200 text-neutral-800 rounded-full py-3 text-[14px] font-medium shadow-sm transition-colors flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-60"
                >
                  {googleLoading ? (
